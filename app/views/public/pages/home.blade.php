...
Конечная оплата производиться по факту доставки груза в гибкие сроки.</p>
                            ...
                            <li>
                                <div class="tab-content-wrapper">
                                    <div class="tab-content-text">
                                        <h3>Доставка</h3>
                                        <p>Rate&Go гарантирует качественный сервис по доставке любых грузов по всему миру. Мы берем на себя обязательства доставить Ваш груза точно в срок. На каждую перевозку предоставляется страховой сертификат от наших партнеров-страховых компаний с высоким мировым рейтингом.<br>
...
Для нас важен результат нашей работы и поэтому мы делаем нашу работу с ювелирной точностью. Мы ценим доверие наших клиентов, партнеров и знаем, что наши клиенты всегда могут рекомендовать нас только с лучшей стороны.</p>
    ...
    <footer class="wrapper">
        ...
        <div class="inner">
            <div class="contacts">
                <h2>Контакты</h2>
                <p>Главный офис:<br>Верхний Вал 4А Киев 04071 Украина</p>
                <p>+380-44-492-4020 - Ukraine</p>
                <p>+7 (495) 133-8777 - RUS</p>
                <p>+420-234-09-2547 - Czech Republic</p>
