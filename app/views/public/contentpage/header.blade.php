        ...
        <div class="header-wrapper top">
            <div class="inner">
                ...
                <header class="header">
                    ...
                    <div class="logo">
                        <a href="/" class="header__logo header__inner">
                            <svg version="1.1" width="150" height="40" id="logo_svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 245.4 47.4" enable-background="new 0 0 245.4 47.4" xml:space="preserve">
            <g>
                <g>
                    ...
                    <nav class="navbar" role="navigation">
                        <div class="menu-block">
                            <div class="collapse navbar-collapse">
                                <div class="menu-btn"><a class="btn btn-default main-btn" href="#" role="button">ГЛАВНАЯ</a></div>
                                <div class="menu-btn"><a class="btn btn-default main-btn" href="/#services" role="button">УСЛУГИ</a></div>
                                <div class="menu-btn"><a class="btn btn-default main-btn" href="#" role="button">СТАТЬИ</a></div>
                                <div class="menu-btn"><a class="btn btn-default main-btn" href="#" role="button">О НАС</a></div>
                                <div class="menu-btn"><a class="btn btn-default main-btn" href="#" role="button">КОНТАКТЫ</a></div>
<div class="language">
